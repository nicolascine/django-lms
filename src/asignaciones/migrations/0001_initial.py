...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'asignaciones_asignacion', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('fecha_incio', self.gf('django.db.models.fields.DateTimeField')()),
            ('total_dias', self.gf('django.db.models.fields.IntegerField')()),
            ('aprobacion_admin', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True)),
            ('timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('updated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal(u'asignaciones', ['Asignacion'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'asignaciones_asignacion')
    ...
    models = {
        u'asignaciones.asignacion': {
            ...
            'curso': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['cursos.Curso']", 'null': 'True', 'symmetrical': 'False'}),
